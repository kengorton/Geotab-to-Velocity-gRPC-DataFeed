    ...
    class FeedProcessor
    {
        ...
        {            
            ...
            try
            {
                ...
                Console.WriteLine(DateTime.UtcNow.ToString() + ": Requesting LogRecord data from " + api.Server + ": " + api.Database);
                ...
                Console.WriteLine(DateTime.UtcNow.ToString() + ": Received "+ feedResults.GpsRecords.Count + " GPS records from " + api.Server + ": " + api.Database);
            ...
            {
                Console.WriteLine(DateTime.UtcNow.ToString() + "; " + e.Message);
                if (e is HttpRequestException)
                {
                    Console.WriteLine(DateTime.UtcNow.ToString() + ": The request to " + api.Server + ": " + api.Database + " experienced an exception of type HttpRequestException. Trying again 5 seconds.");
